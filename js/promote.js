  ...
  items: [
    {
      ...
      builds: [25169, 25170],
      risk: "low",
      what: "New tool (T32, beta-site only): derives the end-user communication from the deployed policies — what people will notice and what will no longer be possible, per audience, with live now / staged / at go-live taken from the policy states and every statement backed by the named policies. The persona baseline (CAxxx-numbered) is analyzed first and carries the brief; policies without a persona number are analyzed last in their own trailing section, marked as possibly temporary (25170). Audience filter, Markdown export via the report viewer, text-based Word export built client-side with JSZip. Reads only the policies already in memory; no Graph calls, no writes.",
      ...
      test: [
        ...
        "On a tenant holding both persona CAxxx policies and unnumbered ones (CloudFellows dev: 99 baseline Off + 6 DEVCF enforced): the header counts ONLY the baseline, every main section is backed exclusively by CAxxx policies, and the unnumbered ones appear solely in the trailing Outside-the-baseline section - on screen, in the Markdown and in the Word file.",
        "On a tenant with no unnumbered policies: no trailing section and no mention of it in the header or exports.",
      ],
