  ...
  items: [
    {
      ...
      test: [
        ...
        "Click a row without ticking: the actions bar must appear naming the open row; 🧹 Migrate and 🔒 Protect from it must land on a RESULT (no Scan button) with that group ticked. ✕ on the bar with nothing ticked closes the drawer.",
        "Dark mode: the actions bar must be deep green with light text and readable buttons.",
