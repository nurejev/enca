  ...
  items: [
    {
      ...
      test: [
        ...
        "tools/pim/New-PimBaseline.ps1 -ConfigFile .\\pim-baseline.json -TenantId cloudfellows.dev -SkipOrchestrator: renames SG-PIM-* to PIM-SG-*, the Duplicate PIM-SG names step lists each doubled name with both copies (oldest KEEP, the other empty) and stops; with -MergeDuplicates the empty copies are deleted and the run continues: creates PIM-SG-AZ-Sub-Owner and -Sub-Contributor, lists the protected accounts, writes the resolved file and stops without importing EasyPIM. A second run straight after finds every group (no duplicates made).",
