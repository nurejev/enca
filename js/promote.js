  ...
  items: [
    {
      ...
      test: [
        "On the beta site (a non-production host): a gear renders next to Sign out after sign-in. On production there must be NO gear - view source is not enough, check the DOM.",
        ...
        "The /pvm front door still wins while its key is selected: the explicit override beats the selfhost fallback.",
      ],
