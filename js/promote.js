...
const PROMOTE = {
  ...
  items: [
    ...
    },
    {
      ...
      builds: [25273, 25275, 25276, 25277, 25278, 25279, 25280, 25284, 25285, 25286, 25287, 25288, 25289, 25290, 25291],
      risk: "medium",
      ...
      test: [
        ...
        "Tick a migrated group and its archive (DG-INT and DG-INT (migrated …)) → Compare → Policies: the grid must list every policy naming either, the rows that name only one of them first and marked 'differs', and the summary must say e.g. 'DG-INT is missing: 4 exclusions'; a policy name must open the card. Members view: the two group columns must be narrow (46px), not stretched across the window.",
