  ...
  items: [
    {
      ...
      builds: [25130, 25131],
      risk: "high",
      what: "\ud83e\uddf9 Archived groups gains select all / deselect all that ticks only the rows safe to delete. \u2466 Migrate's progress lives with the run instead of the panel's elements, a corner badge shows it from any screen with a way back, closing the tab mid-run warns, Rescan refuses while busy, and five delete flows keep the scroll position across their re-render.",
