  ...
  items: [
    {
      ...
      test: [
        ...
        "Run the read on the Perfetti-shaped tenant, Hunting + non-interactive, Last 7 days: it FINISHES (25378 crashed the tab); the coverage line ends with “💾 nothing held for this window yet — all 7 days read from Microsoft and kept on this device for next time”. DevTools → Application → IndexedDB → enca-signins → buckets holds one entry per day.",
