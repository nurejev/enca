...
const PROMOTE = {
  ...
  items: [
    ...
    },
    {
      ...
      test: [
        "Every sidebar row shows the tool's number on the right - T01 through T32, two digits, quiet grey.",
        "Overview, What's new, Roadmap and Help show no number: those pages deliberately carry none, and an empty span must not leave a gap.",
        "Narrow the window until a long name runs out of room (Conditional Access groups, Firewall and ASR coverage): the NAME ellipsises and the number stays put. If the number is what disappears, the row is not flex.",
        "Collapse the rail: numbers go with the names, leaving icons only.",
        "Hover a collapsed icon: the native tooltip reads the full name with the number in brackets.",
