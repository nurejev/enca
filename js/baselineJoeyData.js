...
// Release 2026.2.1 (13-02-2026). Based on the Microsoft Conditional Access
// framework by Claus Jespersen, deliberately minimised.
//
// Built from the repository's README and its Config/ContionalAccess +
// Config/Groups file listing. Joey's personas are Global / Admins /
// Internals / ServiceAccounts / Guests / Agents, which do NOT map onto the
// Limon-IT CA-number ranges (his CA300 block is service accounts, not
// externals), so each policy carries its own persona label.
//
...
const BASELINE_JOEY = {
  ...
  // policies without a JSON in Config/ConditionalAccess are documented in the
  // README only — flagged with configured:false so the card can say so.
  policies: [
    { num: 0, persona: "🌐 Global", name: "CA000-Global-IdentityProtection-AnyApp-AnyPlatform-MFA", configured: true,
    ...
    { num: 1, persona: "🌐 Global", name: "CA001-Global-AttackSurfaceReduction-AnyApp-AnyPlatform-BLOCK-CountryWhitelist", configured: true,
    ...
    { num: 2, persona: "🌐 Global", name: "CA002-Global-IdentityProtection-AnyApp-AnyPlatform-Block-LegacyAuthentication", configured: true,
    ...
    { num: 3, persona: "🌐 Global", name: "CA003-Global-BaseProtection-RegisterOrJoin-AnyPlatform-MFA", configured: true,
    ...
    { num: 4, persona: "🌐 Global", name: "CA004-Global-IdentityProtection-AnyApp-AnyPlatform-AuthenticationFlows", configured: true,
      grant: "Block access", resources: "All cloud apps", platform: "Any platform",
      description: "Prevents transferring authentication flows (e.g. PC to mobile). Currently a preview feature." },
    { num: 5, persona: "🌐 Global", name: "CA005-Global-DataProtection-Office365-AnyPlatform-Unmanaged-RequireAppProtection", configured: true,
      grant: "Require app protection policy", resources: "Office 365", platform: "Unmanaged devices",
      description: "Requires app protection policies on unmanaged devices. Changed in 2026.2.1 from 'Require approved client app', which retires in March 2026." },
    { num: 6, persona: "🌐 Global", name: "CA006-Global-DataProtection-Office365-iOSenAndroid-RequireAppProtection", configured: true,
    ...
    { num: 100, persona: "🛡 Admins", name: "CA100-Admins-IdentityProtection-AdminPortals-AnyPlatform-MFA", configured: true,
      grant: "Require MFA", resources: "Microsoft Admin Portals", platform: "Any platform",
      description: "Requires MFA for selected admin roles when accessing the admin portals. Assumes admin roles are only assigned to admin accounts." },
    { num: 101, persona: "🛡 Admins", name: "CA101-Admins-IdentityProtection-AnyApp-AnyPlatform-MFA", configured: true,
      grant: "Require MFA", resources: "All cloud apps", platform: "Any platform",
      description: "Requires MFA for selected admin roles on any cloud app." },
    { num: 102, persona: "🛡 Admins", name: "CA102-Admins-IdentityProtection-AllApps-AnyPlatform-SigninFrequency", configured: true,
    ...
    { num: 103, persona: "🛡 Admins", name: "CA103-Admins-IdentityProtection-AllApps-AnyPlatform-PersistentBrowser", configured: true,
    ...
    { num: 104, persona: "🛡 Admins", name: "CA104-Admins-IdentityProtection-AllApps-AnyPlatform-ContinuousAccessEvaluation", configured: true,
    ...
    { num: 105, persona: "🛡 Admins", name: "CA105-Admins-IdentityProtection-AnyApp-AnyPlatform-PhishingResistantMFA", configured: true,
      grant: "Authentication strength: phishing-resistant MFA", resources: "All cloud apps", platform: "Any platform",
      description: "Requires phishing-resistant MFA for admins. Excludes Microsoft Graph Command Line Tools; includes Global Reader and Intune Administrator in the role selection." },

    { num: 200, persona: "👤 Internals", name: "CA200-Internals-IdentityProtection-AnyApp-AnyPlatform-MFA", configured: true,
      grant: "Require MFA", resources: "All cloud apps", platform: "Any platform",
    ...
    { num: 201, persona: "👤 Internals", name: "CA201-Internals-IdentityProtection-AnyApp-AnyPlatform-BLOCK-HighRiskUser", configured: true,
    ...
    { num: 202, persona: "👤 Internals", name: "CA202-Internals-IdentityProtection-AllApps-WindowsMacOS-SigninFrequency-UnmanagedDevices", configured: true,
    ...
    { num: 203, persona: "👤 Internals", name: "CA203-Internals-AppProtection-MicrosoftIntuneEnrollment-AnyPlatform-MFA", configured: true,
    ...
    { num: 204, persona: "👤 Internals", name: "CA204-Internals-AttackSurfaceReduction-AllApps-AnyPlatform-BlockUnknownPlatforms", configured: true,
    ...
    { num: 205, persona: "👤 Internals", name: "CA205-Internals-BaseProtection-AnyApp-Windows-CompliantorAADHJ", configured: true,
    ...
    { num: 206, persona: "👤 Internals", name: "CA206-Internals-IdentityProtection-AllApps-AnyPlatform-PersistentBrowser", configured: true,
    ...
    { num: 207, persona: "👤 Internals", name: "CA207-Internals-AttackSurfaceReduction-SelectedApps-AnyPlatform-BLOCK", configured: true,
    ...
    { num: 208, persona: "👤 Internals", name: "CA208-Internals-BaseProtection-AnyApp-MacOS-Compliant", configured: true,
    ...
    { num: 209, persona: "👤 Internals", name: "CA209-Internals-IdentityProtection-AllApps-AnyPlatform-ContinuousAccessEvaluation", configured: true,
      grant: "Session: continuous access evaluation", resources: "All cloud apps", platform: "Any platform",
      description: "Near-real-time re-evaluation of internal user access. Cannot be created in report-only — On or Off only." },
    { num: 210, persona: "👤 Internals", name: "CA210-Internals-IdentityProtection-AnyApp-AnyPlatform-BLOCK-HighRiskSignIn", configured: true,
    ...
    { num: 300, persona: "⚙ Service accounts", name: "CA300-ServiceAccounts-IdentityProtection-AnyApp-AnyPlatform-MFA", configured: false,
      grant: "Require MFA", resources: "All cloud apps", platform: "Any platform",
    ...
    { num: 301, persona: "⚙ Service accounts", name: "CA301-ServiceAccounts-AttackSurfaceReduction-AllApps-AnyPlatform-BlockUntrustedLocations", configured: false,
    ...
    { num: 400, persona: "🙋 Guests", name: "CA400-GuestUsers-IdentityProtection-AnyApp-AnyPlatform-MFA", configured: true,
      grant: "Require MFA", resources: "All cloud apps", platform: "Any platform",
      description: "Requires MFA for guests on any cloud app, from any platform." },
    { num: 401, persona: "🙋 Guests", name: "CA401-GuestUsers-AttackSurfaceReduction-AllApps-AnyPlatform-BlockNonGuestAppAccess", configured: true,
    ...
    { num: 402, persona: "🙋 Guests", name: "CA402-GuestUsers-IdentityProtection-AllApps-AnyPlatform-SigninFrequency", configured: true,
      grant: "Session: sign-in frequency 12 hours", resources: "All cloud apps", platform: "Any platform",
      description: "Sign-in frequency of 12 hours for guests, on any device." },
    { num: 403, persona: "🙋 Guests", name: "CA403-Guests-IdentityProtection-AllApps-AnyPlatform-PersistentBrowser", configured: true,
      grant: "Session: never persistent browser", resources: "All cloud apps", platform: "Any platform",
      description: "Prevents persistent browser sessions for guests." },
    { num: 404, persona: "🙋 Guests", name: "CA404-Guests-AttackSurfaceReduction-SelectedApps-AnyPlatform-BLOCK", configured: true,
      grant: "Block access", resources: "Selected apps", platform: "Any platform",
    ...
    { num: 501, persona: "🤖 Agents", name: "CA501-Agents-IdentityProtection-AnyApp-AnyPlatform-BLOCK-HighRiskAgent", configured: false,
      grant: "Block access", resources: "All cloud apps", platform: "Any platform", conditions: "Agent risk: high",
      description: "Blocks agent identities at high risk level. Adopted from the template policy in 2026.2.1. Documented in the README; no policy JSON ships in the repository." },
  ],
};
...
BASELINE_JOEY.policies.forEach((p) => {
  ...
  p.docUrl = `${BASELINE_JOEY.url}#${p.name.toLowerCase().replace(/[^a-z0-9]+/g, "")}`;
});
