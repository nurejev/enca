...
const { C } = box;
const sku = (plans) => [{ capabilityStatus: "Enabled", skuPartNumber: "SPE_E5", servicePlans: plans.map((n) => ({ servicePlanName: n, servicePlanId: n === "AAD_PREMIUM_P2" ? "eec0eb4f-6444-4f95-aba0-50c24d67f998" : n === "AAD_PREMIUM" ? "41781fb2-bc02-4b7c-bd55-b576c07bb09d" : n, provisioningStatus: "Success" })) }];
